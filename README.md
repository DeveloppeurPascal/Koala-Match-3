...
>
> Maintenance of this project has been moved to Codeberg at https://codeberg.org/Gamolf/Koala-Match-3
>
...
> [!NOTE]
> To open or work on a ticket for this project, go to https://codeberg.org/Gamolf/Koala-Match-3/issues
> To make a PULL REQUEST on this project, go to https://codeberg.org/Gamolf/Koala-Match-3/pulls
> For any other information or to contact me, you can also visit the project website at https://koalamatch3.gamolf.fr or its devlog at https://developpeur-pascal.fr/koala-match-3.html
...
Visit [the Koala Match 3 website](https://koalamatch3.gamolf.fr) to download the compiled version, learn more about how it works, access videos and articles, find out about the different versions available and their features, contact user support...
...
To download this code repository, we recommend using "git", but you can also download a ZIP file directly from [its Codeberg repository](https://codeberg.org/Gamolf/Koala-Match-3).
...
If you detect any anomalies on earlier versions, please don't hesitate to [report them](https://codeberg.org/Gamolf/Koala-Match-3/issues) so that I can test and try to correct or provide a workaround.
...
If you want an answer from the project owner the best way to ask for a new feature or report a bug is to go to [the Codeberg repository](https://codeberg.org/Gamolf/Koala-Match-3) and [open a new issue](https://codeberg.org/Gamolf/Koala-Match-3/issues).
